...
pacer mypacer;
pacer.heart = heartbeat_init(vic_win_size, vic_buf_depth, vic_log_file, vic_min_target, vic_max_target);
pacer.domid = getDomid();  
pacer.xs = xs_daemon_open();
pacer.base_path = xs_get_domain_path(xs, domid);
